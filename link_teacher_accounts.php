<?php
/**
 * الحسابات اليتيمة للمعلمين
 * حسابات بدون سجل معلم مرتبط - للحذف فقط
 */

$pageTitle = 'حسابات المعلمين اليتيمة';
...
<div class="page-header d-flex justify-between align-center flex-wrap gap-2">
    <div>
        <h1>🗑️ حسابات المعلمين اليتيمة</h1>
        <p>حسابات بدون سجل معلم مرتبط</p>
    </div>
    <div class="d-flex gap-2 flex-wrap">
        <a href="users.php" class="btn btn-secondary">← إدارة المستخدمين</a>
        <a href="teachers.php" class="btn btn-primary">👨‍🏫 المعلمين</a>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="empty-state" id="emptyState">
            ...
            <p>جميع حسابات المعلمين مرتبطة بسجلات معلمين</p>
        </div>
        <?php else: ?>
...
<div class="card mt-4">
    ...
    <div class="card-body">
        <p style="color: var(--text-secondary);">
            الحسابات اليتيمة هي حسابات مستخدمين من نوع "معلم" ليس لها سجل معلم مرتبط في جدول المعلمين.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-btn').forEach(btn => {
        btn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('link_teacher_accounts.php', {
                    method: 'POST',
                ...
                if (data.success) {
                    ...
                    // رسالة نجاح
                    if (typeof notifySuccess !== 'undefined') {
